...
OWNER_ID = int(getenv("6474577612", None))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/xaiko-avg/xaikoavg",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/cari_pacar_jodoh_teman")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/ofcbotxaiko")

# Set this to True if you want the assistant to automatically leave chats after an interval
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", Ture))
